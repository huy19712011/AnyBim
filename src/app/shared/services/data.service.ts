...
export class DataService {
  ...
  update(item: any): Observable<any> {
    ...
    **/
    ...
    return this.http.put<any>(`${this.URL_API}/${item.id}`, item, options)
     .pipe(
  ...
  remove(item: any): Observable<any> {
    return this.http.delete<any>(`${this.URL_API}/${item.id}`)
      .pipe(
  ...
  create(item: any): Observable<any> {
    ...
    return this.http.post<any>(`${this.URL_API}`, item, options)
      .pipe(
